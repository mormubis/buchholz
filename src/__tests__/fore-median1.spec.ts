...
import { foreBuchholzMedian1 } from '../fore-median1.js';
...
describe('foreBuchholzMedian1', () => {
  it('excludes least and most significant fore contributions', () => {
    expect(foreBuchholzMedian1('A', ROUNDS, PLAYERS)).toBe(1.5);
  });
});
