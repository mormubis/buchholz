...
import { foreBuchholzCut1 } from '../fore-cut1.js';
...
describe('foreBuchholzCut1', () => {
  it('excludes the least significant fore contribution', () => {
    expect(foreBuchholzCut1('A', ROUNDS, PLAYERS)).toBe(3);
  });
});
