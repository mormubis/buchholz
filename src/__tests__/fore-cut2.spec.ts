...
import { foreBuchholzCut2 } from '../fore-cut2.js';
...
describe('foreBuchholzCut2', () => {
  it('excludes the two least significant fore contributions', () => {
    expect(foreBuchholzCut2('A', ROUNDS, PLAYERS)).toBe(1.5);
  });
});
