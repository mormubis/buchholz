...
import { averageOpponentsBuchholzFore } from '../average-fore.js';
...
describe('averageOpponentsBuchholzFore', () => {
  it('averages opponents fore buchholz over the board and rounds half up', () => {
    expect(averageOpponentsBuchholzFore('A', ROUNDS, PLAYERS)).toBe(5);
  });
});
